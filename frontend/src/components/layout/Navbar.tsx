...
import {
  Bell, Menu, X, Search, LayoutDashboard, CalendarCheck,
  LogOut, User,
} from 'lucide-react'
              ...
              <DropdownMenu.Root>
                <DropdownMenu.Trigger asChild>
                  <button className="flex items-center gap-2 rounded-full border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 hover:shadow-md transition-shadow duration-200">
                    ...
                    <div className="flex h-7 w-7 items-center justify-center rounded-full bg-dark text-white text-xs font-semibold uppercase">
